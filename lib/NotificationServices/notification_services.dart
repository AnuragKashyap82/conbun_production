// import 'dart:async';
// import 'dart:convert';
// import 'package:conbun_production/Agora/make_text_call.dart';
// import 'package:conbun_production/Views/call_notification_screen.dart';
...
//   AppointmentsController appointmentsController = Get.put(AppointmentsController());
...
//     if (payload != null) {
//       Map<String, dynamic> data = jsonDecode(payload);
//       String meetingChannelName = data['data']['agoraMeetingChannel'] ?? 'No channel name';
...
//             // sound: RawResourceAndroidNotificationSound('ring'
//             sound: RawResourceAndroidNotificationSound('ringtone'),
//             autoCancel: false, // Prevents the notification from dismissing automatically
