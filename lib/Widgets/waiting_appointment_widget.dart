...
class WaitingAppointentWidget extends StatefulWidget {
  ...
  const WaitingAppointentWidget({super.key, required this.isDivider, required this.changeScreenFunction, required this.goToScreenConsultantName, required this.call, required this.appointmentModel, required this.isMoreButton});

  @override
  State<WaitingAppointentWidget> createState() => _WaitingAppointentWidgetState();
}

class _WaitingAppointentWidgetState extends State<WaitingAppointentWidget> {
